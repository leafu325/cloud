...
class P2PNode:
    ...
    def _listen(self):
        ...
        while True:
            ...
            if info.split(',')[0] == 'other_chekcAllChains':
            ...
            elif info.split(',')[0] == 'chekcAllChains' and info.split(',')[2] == local_addr:
                ...
                with open(volume_locate+last_block,'r') as f:
                    ...
                    print(f"hsh_code:{hsh_code} from ({local_addr}, 8001)")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if commands[0] == "transaction":
            ...
            command = f"other_chekcAllChains,{local_addr}"
