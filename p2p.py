...
port = 8001 #�~\��~@�~^�~Z~Dport 
peers = [('172.17.0.6', 8001), ('172.17.0.7', 8001)]  #�~_�~O��~V�~L�~@~KIP:8001 ��
    ...
    def _listen(self):
        while True:
            ...
            if info == "checkAllChains":
                ...
                print(f"hsh_code:{hsh_code} from {addr}")

                for peer in self.peers:
                    self.sock.sendto(hsh_code.endoce('utf-8'), peer)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if commands[0] == "transaction":
            ...
            checkAllChain(node,"checkAllChains")
