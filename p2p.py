...
class P2PNode:
    def __init__(self, port, peers):
        ...
        self.sock.bind(('172.17.0.10', self.port)) #�~@~Y�~X��~\��~@�~^�~Z~D IP
    ...
    def _listen(self):
        ...
        while True:
            ...
            if info.split(',')[0] == 'other_chekcAllChains':
                other_chekcAllChains(self,info.split(',')[1])
            ...
            elif info.split(',')[0] == 'chekcAllChains' and info.split(',')[3] == '172.17.0.10':
                ...
                with open(volume_locate+last_block,'r') as f:
                    ...
                    print(f"hsh_code:{hsh_code} from ('172.17.0.10', 8001)")

                print(f"Hash code:{info.split(',')[0]} from {addr}")
                if test_hsh_code != info.split(',')[0]:
                    print(f"('172.17.0.10', 8001) or {addr} -> NO")
                else:
                    print(f"('172.17.0.10', 8001) or {addr}->Yes")
...
def other_chekcAllChains(self,start_addr):
    with open(volume_locate+'0.txt', mode = 'r') as super_block:
        last_block = super_block.readline().split(':')[1].strip()
    ...
    with open(volume_locate+last_block,'r') as f:
        ...
        message = f"hekcAllChains,{hsh_code},{start_addr}"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if commands[0] == "transaction":
            ...
            command = f"other_chekcAllChains,'172.17.0.10'"
